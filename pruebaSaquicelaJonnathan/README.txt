...
a persistence unit "pruebaSaquicelaJonnathanPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebaSaquicelaJonnathan/pom.xml":
...
artifact ("pruebaSaquicelaJonnathan.war") is already built. You can build
